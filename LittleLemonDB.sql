...
INSERT INTO `bookings` VALUES (1,1,'2022-12-10',5),(2,2,'2022-12-11',3),(99,99,'2022-12-10',99),(517,1,'2022-12-12',8);
...
INSERT INTO `customers` VALUES (1,'John Doe','123456789'),(2,'Jane Smith','987654321');
...
INSERT INTO `menuitems` VALUES (1,'Pizza',10.00),(2,'Pasta',12.00),(3,'Burger',8.00);
...
INSERT INTO `orderdetails` VALUES (1,1,1,2),(2,1,2,5),(3,2,3,1);
...
INSERT INTO `orders` VALUES (1,1,250.00),(2,2,150.00);
...
BEGIN
    ...
    IF count_booking = 0 THEN
        ...
        VALUES (RAND()*1000, 1, booking_date, table_number);
...
-- Dump completed on 2026-04-20  8:40:08
